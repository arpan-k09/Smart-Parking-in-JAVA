                    ...
                    <div class="table-wrapper">
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>1.</td>
                                    <td>Surat Railway Pay And Park</td>
                                    <td style="padding-top:1.5em"><a href="space10.jsp" class="button special fit">Book Slot</a></td>
                                </tr>
                                <tr>
                                    <td>2.</td>
                                    <td>Free Parking For Students Studying Centre Of SMC</td>
                                    <td style="padding-top:1.5em"><a href="space5.jsp" class="button special fit">Book Slot</a></td>
                                </tr>
