                    ...
                    <div class="table-wrapper">
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>1.</td>
                                    <td>Law Chamber Parking</td>
                                    <td style="padding-top:1.5em"><a href="space11.jsp" class="button special fit">Book Slot</a></td>
                                </tr>
                                <tr>
                                    <td>2.</td>
                                    <td>Madhuvan Parking</td>
                                    <td style="padding-top:1.5em"><a href="space12.jsp" class="button special fit">Book Slot</a></td>
                                </tr>
